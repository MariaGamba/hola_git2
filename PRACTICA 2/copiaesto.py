...
print("La ultima vez que se modifico el archivo README:", modifico_tiempo) #  imprime el tiempo de modificacion del archivo README
...
try:
    ...
    os.rename(dir_modules_archivo_c1, dir_modules_archivo_c1_copia) #  renombra el archivo "c1" en "modules" a "archivo_c1_copia.txt"
except:
...
try:
    ...
    os.rename(dir_modules_archivo_c2, dir_modules_archivo_c2_copia) #  renombra el archivo "c2" en "modules" a "archivo_c2_copia.txt"
except:
...
if os.path.exists(dir_archivo_c1):
    ...
    print("En la carpeta c1 se encontraron los archivos:", os.listdir(), "y han sido eliminados") #  imprime los archivos encontrados
...
if os.path.exists(dir_archivo_c2):
    ...
    print("En la carpeta c2 se encontraron los archivos:", os.listdir(), "y han sido eliminados") #  imprime los archivos encontrados
